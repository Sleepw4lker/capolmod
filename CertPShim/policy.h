...
class CCertPolicyShim: 
    public CComDualImpl<ICertPolicy2, &IID_ICertPolicy2, &LIBID_CERTPOLICYSHIMLib>, 
    public ISupportErrorInfo,
    public CComObjectRoot,
    public CComCoClass<CCertPolicyShim, &CLSID_CCertPolicyShim>
{
public:
    CCertPolicyShim()
    {
...
DECLARE_NOT_AGGREGATABLE(CCertPolicyShim) 
// Remove the comment from the line above if you don't want your object to 
// support aggregation.  The default is to support it

DECLARE_REGISTRY(
    CCertPolicyShim,
    wszCLASS_CERTPOLICYSHIM TEXT(".1"),
...
private:
	...
	ICertPolicy2 *m_pWinDefCertPol2;
};
...
public:
    ...
    CCertPolicyShim *GetPolicy() { return(m_pPolicy); }
